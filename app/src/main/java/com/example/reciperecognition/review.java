...
public class review extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        e1=(EditText)findViewById(R.id.editTextTextMultiLine1);
    ...
    public void onClick(View view) {
        ...
        else
        {
            ...
            String url = "http://" + hu + ":1234//review";
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                    Toast.makeText(getApplicationContext(), "submit Succussfully", Toast.LENGTH_SHORT).show();
